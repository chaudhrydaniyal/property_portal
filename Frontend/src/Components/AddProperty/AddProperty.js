                    ...
                    <Card className='p-5 res'>
                        ...
                        <Card style={{ border: "none" }}>
                            ...
                            <Form>
                                ...
                                <Form.Control placeholder='Title' className='dd'></Form.Control>
                                <Form.Label className='mt-3'>Price</Form.Label>
                                <Form.Control type="number" placeholder='price' className='dd'></Form.Control>
                                  </div>
                                 </div>
                                <div className='ff'>
                                   <div>
                                   <Form.Label className='mt-3 select'>Property type</Form.Label>
                                    <Form.Select>
                                   ...
                                   <Form.Label className='mt-3 select'>City</Form.Label>
                                    ...
                                    <div>
                                        ...
                                        <Form.Control placeholder='area' className='select'></Form.Control>
                                    </div>
                                ...
                                <Form.Control placeholder='street address'></Form.Control>
                                <Form.Label className='mt-3 dd'>Description</Form.Label>
                                <Form.Control as={'textarea'}rows={'4'} className="tex"></Form.Control>
                                 </div>
                                </div>
                                
                                <Button variant='success' className='mt-3'>Add Property</Button>
                            </Form>
